...
state_totals |> 
  ...
  labs(x = "Total",
       y = "States",
       title = "Top Ten States with most Covid Cases")
```
...
>California had the most cases from January 2020 and March 2023. There is also a higher population in California, so there is a higher number of cases in the area that might contribute to this total. 


### Other Question
**Is this the best way to look at our data? Is looking at just the total number of cases the best way to compare states?**

>No, looking at the cases per cappa might be better. Because some states have a higher number of population, this total number of cases could be read as a lot of people compared to a state with fewer people. 
...
>How they retrieved the data could be biased or leave some information out, leave some missing or unacounted covid cases. 
...
> Vaccination rate in relation to this data could be intresting. Average age as well as if the individual is imuno compromised could shed more light into the impact of covid.   
